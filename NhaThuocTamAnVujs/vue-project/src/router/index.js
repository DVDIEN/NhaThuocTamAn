...
import HoaDonAdmin from '@/views/Admin/HoaDonAdmin.vue'
import ChiTietHoaDon from '@/views/Admin/ChiTietHoaDon.vue'
import KhoHangAdmin from '@/views/Admin/KhoHangAdmin.vue'
import LichSuNhapXuat from '@/views/Admin/LichSuNhapXuat.vue'
...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: 'hoa-don', component: HoaDonAdmin },
      { path: 'chi-tiet-hoa-don/:maHD', component: ChiTietHoaDon },
      { path: 'kho-hang', component: KhoHangAdmin },
      { path: 'lich-su-nhap-xuat', component: LichSuNhapXuat },
